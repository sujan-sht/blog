            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            <form action="{{'/settings/edit/' . $setting->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="footer" value="{{ old('footer',$setting->footer) }}">
                                        </div>
